...
time_one_homework = (number_of_hours / homework_sum)
print(time_one_homework)
...
print(f" Курс: {course_name}, всего задач:{homework_sum}, затрачено часов: {number_of_hours}, "
      f"среднее время выполнения {time_one_homework} часа.")
